...
const SvgComponent = (props: SVGProps<SVGSVGElement>, ref: Ref<SVGSVGElement>) => {
  ...
  return (
    ...
    >
      ...
      <path
        d={
          'M77.889 54.454a.651.651 0 0 1-.643-.643v-9.24a.643.643 0 0 1 1.285 0v9.249a.643.643 0 0 1-.642.634ZM77.889 41.777a.643.643 0 0 1-.643-.643V39.24a.643.643 0 0 1 1.285 0v1.903a.634.634 0 0 1-.642.634ZM25.786 32.503h-3.559a.668.668 0 0 1 0-1.335h3.56a.667.667 0 0 1 0 1.335Z'
        }
        fill={'#BEA6FF'}
      />
      <path
        d={
          'M24.007 34.282a.668.668 0 0 1-.667-.667v-3.559a.668.668 0 0 1 1.335 0v3.56a.668.668 0 0 1-.668.666ZM36.857 73.714a.857.857 0 1 1 0 1.715.857.857 0 0 1 0-1.715ZM31.714 73.714a.857.857 0 1 1 0 1.715.857.857 0 0 1 0-1.715ZM26.571 73.714a.857.857 0 1 1 0 1.715.857.857 0 0 1 0-1.715Z'
        }
        fill={'#BEA6FF'}
      />
      <path d={'m47.864 23.242-24.1 19.799 24.1 19.808 24.1-19.808-24.1-19.8Z'} fill={fill} />
      <path
        d={
          'M47.865 63.544a.667.667 0 0 1-.418-.195l-24.1-19.808a.698.698 0 0 1-.182-.833.725.725 0 0 1 .183-.242l24.1-19.799a.695.695 0 0 1 .926 0l24.1 19.799a.725.725 0 0 1 .25.537.695.695 0 0 1-.25.538l-24.1 19.808a.668.668 0 0 1-.51.195ZM24.859 43.04l23.006 18.91L70.87 43.04l-23.006-18.9-23.006 18.9Z'
        }
        fill={'#BEA6FF'}
      />
      <path d={'M65.013 28.803H30.717v40.784h34.296V28.803Z'} fill={fill} />
      <path d={'m55.41 40.853-11.716 9.63v19.104h21.319V40.853H55.41Z'} fill={fill} />
      <path
        d={
      ...
      />
      <path
        d={'m47.864 62.849-7.952-6.535-16.147 13.273h48.2L55.816 56.314l-7.953 6.535Z'}
        fill={fill}
      />
      <path
        d={
      ...
      <path
        d={
          'M23.765 70.282a.669.669 0 0 1-.296-.074.686.686 0 0 1-.399-.62V43.04a.685.685 0 0 1 .399-.62.695.695 0 0 1 .741.083l16.147 13.273a.704.704 0 0 1 0 1.075L24.21 70.115a.686.686 0 0 1-.445.167Zm.695-25.768v23.6l14.358-11.8-14.358-11.8Z'
        }
        fill={'#BEA6FF'}
      />
      <path
        d={'m60.424 60.095-10.15 8.343-7.08-5.821-8.473 6.97h37.243l-11.54-9.492Z'}
        fill={fill}
      />
      <path
        d={
