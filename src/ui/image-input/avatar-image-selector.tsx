...
>
export const AvatarImageSelector = forwardRef<ElementRef<typeof ImageInput>, AvatarInputProps>(
  (props, forwardedRef) => {
    const { className, value, onValueChange, initialContent, ...restProps } = props
