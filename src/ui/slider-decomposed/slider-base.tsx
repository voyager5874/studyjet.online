import type * as Radix from './radix-helpers//react/react-primitive'
import type { Scope } from './radix-helpers/react/create-context'

import * as React from 'react'

import { composeEventHandlers } from './radix-helpers/core/compose-event-handlers'
import { clamp } from './radix-helpers/core/number'
import { useComposedRefs } from './radix-helpers/react/compose-refs'
import { createCollection } from './radix-helpers/react/create-collection'
import { createContextScope } from './radix-helpers/react/create-context'
import { Primitive } from './radix-helpers/react/react-primitive'
import { useControllableState } from './radix-helpers/react/use-controllable-state'
import { useDirection } from './radix-helpers/react/use-direction'
import { usePrevious } from './radix-helpers/react/use-previous'
import { useSize } from './radix-helpers/react/use-size'
...
interface SliderProps
  extends Omit<
    ...
    'defaultValue' | keyof SliderOrientationPrivateProps
  > {
  defaultValue?: number[]
  dir?: Direction
  disabled?: boolean
...
type SliderOrientationPrivateProps = {
  ...
  onStepKeyDown(step: { direction: number; event: React.KeyboardEvent }): void
}
...
const SliderThumb = React.forwardRef<SliderThumbElement, SliderThumbProps>(
  (props: ScopedProps<SliderThumbProps>, forwardedRef) => {
    ...
    return <SliderThumbImpl {...props} index={index} ref={composedRefs} />
  }
)
...
const BubbleInput = (props: Radix.ComponentPropsWithoutRef<'input'>) => {
   ...
   */
  return <input style={{ display: 'none' }} {...inputProps} defaultValue={value} ref={ref} />
}
